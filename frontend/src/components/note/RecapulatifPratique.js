...
function RecapulatifPratique() {
            ...
            if (note.CODEETUDIANT === etudiantId) {
                matieres.forEach(matiere => {
                    if (matiere.MODULEID === note.MODULEID) {
                        avg += note.PR * matiere.COEIFFICIENT
    ...
    return (
        <>
            <p className="fs-2 fw-bold text-white">RECAPILUTATIF DES EXMANES PRATIQUE</p>
            <RechercherEtudaint
...
export default RecapulatifPratique
